...
btn_x_minus = tk.Button(frame_x, text="X-", command=lambda: update_x(-1),width=16)
btn_x_minus.pack(side='left', padx=20,pady=10)

btn_x_plus = tk.Button(frame_x, text="X+", command=lambda: update_x(1),width=16)
...
btn_y_minus = tk.Button(frame_y, text="Y-", command=lambda: update_y(-1),width=16)
btn_y_minus.pack(side='left', padx=20,pady=10)

btn_y_plus = tk.Button(frame_y, text="Y+", command=lambda: update_y(1),width=16)
